...
def i_ip_find(bot,chat,sms):
    msg = """👀 El comando /ip_find se usa de la siguiente manera :

👉 /ip_find (ip-limite)

ℹ️ Esta función capta la IP enviada al bot y el límite y comenzará a escanear las IP y al final te dirá si son IP válidas o inválidas .

➕ Este comando viene conjunto con /listar_(on|off)"""
    bot.editMessageText(chat_id=chat,message_id=sms.message_id,text=msg)
